...
class FVM_Activate {
	...
	public static function activate() {
		...
		$rel_table_name = $wpdb->prefix . FVM_REL_TABLE_NAME;
		...
		// Set the initial database version if it doesn't exist
		add_option( FVM_Upgrade::DB_VERSION_OPTION, '0' );
